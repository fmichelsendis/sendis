...
```{css, echo=FALSE}
.holds-the-iframe {
  background:url(examples/pacman_loader.gif) center center no-repeat;
 }
```
 
<p align="center">
<div class="holds-the-iframe"><iframe src="myplot.html" width="750" height="450" scrolling="no" seamless="seamless" frameBorder="0"> </iframe></div>
</p>
