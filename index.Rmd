...
[Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. [Rmarkdown](https://rmarkdown.rstudio.com/) is used to generate automated diagnosis pdf reports. 
</div>
