...
The ability of a nuclear data library to accurately reproduce, in particle-transport simulations, the observables of integral *benchmark* experiments plays a decisive role in the data validation process. 

* How do different nuclear data libraries compare in terms of integral performance? 
* How do different benchmarking *suites* compare to each other?
* How to easily spot general trends and outliers? 
